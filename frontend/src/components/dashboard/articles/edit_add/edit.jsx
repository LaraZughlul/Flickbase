...
import WYSIWYG from '../../../../utils/form/tiptap'; //what you see is what you get
        ...
        <>
            ...
            {loading ?
                ...
                <form className='mt-3 article_form' onSubmit={formik.handleSubmit}>
                    ...
                    {editorContent ?
                        <div className='form-group'>
                            <WYSIWYG editorContent={editorContent} setEditorState={(state) => handleEditorState(state)} />
                        </div>
                        : null}

                    <div className='form-group'>
                        <TextField style={{ width: '100%' }} name="excerpt" label="Enter a short desc" variant='outlined' {...formik.getFieldProps('excerpt')} {...errorHelper(formik, 'excerpt')} multiline /*so like a text area*/ rows={4} />
                    </div>
                    ...
                    <FormControl fullWidth>
                        ...
                        <Select name="category" label="Select a category" {...formik.getFieldProps('category')} error={formik.errors.category && formik.touched.category ? true : false}>
                            <MenuItem value=""><em>None</em></MenuItem>
                            {articles.categories ?
