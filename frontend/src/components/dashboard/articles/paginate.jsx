                        ...
                        <tbody>
                            {articles.docs.map(item => (
                                <tr key={item._id}>
                                    ...
                                    <td>{item.title}</td>
                                    <td>{item.score}</td>
                                    <td className='action_btn remove_btn' onClick={() => handleShow(item._id)}> Remove </td>
                                    <td className='action_btn edit_btn' onClick={() => goToEdit(item._id)}> Edit </td>
                                    <td className='action_btn status_btn' onClick={() => handleStatusChange(item.status, item._id)}> {item.status} </td>
                                </tr>
                            ))}
                        </tbody>
                    </Table>
