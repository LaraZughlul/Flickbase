...
const EmailStepper = ({ user, closeModal }) => {
    ...
    const backBtn = () => (
        <Button className='mt-3 me-3' variant='contained' color='primary' onClick={handleBack}>
            Back
        </Button>
    )
            ...
            {user.loading ?
                ...
                <>
                    ...
                    <form className='mt-3 stepper_form' onSubmit={formik.handleSubmit}>
                        ...
                        {activeStep === 1 ?
                            <div className='form-group'>
                                <TextField style={{ width: '100%' }} name='newemail' label='Enter your new email' variant='outlined' {...formik.getFieldProps('newemail')} {...errorHelper(formik, 'newemail')} />
                                {backBtn()}
                        ...
                        {activeStep === 2 ?
                            <div className='form-group'>
                                <Button className='mt-3 me-3' variant='contained' color='primary' onClick={formik.submitForm}>
                                    Yes, change my email
                                </Button>
                                {backBtn()}
                            </div>
